    ...
    async with session.get(url) as response:
        ...
        if portfolio_book_ul is not None:
            ...
            for item in portfolio_items:
                ...
                book_id = re.search(r'/book-content-(\d+)\.html', link).group(1)
                book_info.append([title, author, time, f"https://www.dalanmei.com{link}", book_id])
...
async def main():
    ...
    # 保存 Excel 文件
    workbook.save('books_async_07.xlsx')
