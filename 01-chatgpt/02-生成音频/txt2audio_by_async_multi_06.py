...
if __name__ == '__main__':
    # 将大文本分成多个小块
    chunk_size = len(text) // 40  # 分成四块，可以根据需要调整
    ...
    # 合并音频块
    audio_segments = [AudioSegment.from_mp3(output_file) for output_file in output_files]
    ...
    print("所有文本块已转换并合并为音频。")


from gtts import gTTS

tts = gTTS(text, lang='en', tld='com', lang_check=True, slow=False)
